...
public class Juicer {
    ...
    public static <T extends Fruit> void make3(FruitBox<? super Apple> fruitBox){
...
//    }
//    메서드 중복 정의, 정의 불가
//    public static void make(FruitBox<Grape> grapeFruitBox){
//        List<Grape> items = grapeFruitBox.getItems();
//        System.out.println(items);
 //   }
}
